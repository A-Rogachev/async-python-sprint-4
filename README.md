...
```
-- Клонировать репозиторий, далее перейти в папку проекта, развернуть приложение с помощью Docker Compose
sudo docker compose up -d
-- После завершения работы с проектом, удалить контейнеры и volumes.
